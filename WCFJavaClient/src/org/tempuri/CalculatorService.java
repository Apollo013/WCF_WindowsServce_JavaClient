 ...
 * 
 */
@WebServiceClient(name = "CalculatorService", targetNamespace = "http://tempuri.org/", wsdlLocation = "http://localhost:8932/WCFCalculatorService/service?wsdl")
    ...
    extends Service
{
    ...
    private final static QName CALCULATORSERVICE_QNAME = new QName("http://tempuri.org/", "CalculatorService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8932/WCFCalculatorService/service?wsdl");
    ...
    public ICalculator getBasicHttpBindingICalculator() {
        return super.getPort(new QName("http://tempuri.org/", "BasicHttpBinding_ICalculator"), ICalculator.class);
    }
    ...
    public ICalculator getBasicHttpBindingICalculator(WebServiceFeature... features) {
        return super.getPort(new QName("http://tempuri.org/", "BasicHttpBinding_ICalculator"), ICalculator.class, features);
    }
